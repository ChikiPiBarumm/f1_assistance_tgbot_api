...
public interface IStandingsHandler
{
    ...
    Task HandleStandingsCallbackAsync(Message message, string action, string? yearValue, string? roundValue, string? meetingKeyValue, CancellationToken cancellationToken);
}
